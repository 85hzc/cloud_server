  ...
  /*      if(deviceId == "HHH"){
        ...
        client.query(selectStr,function(err,results){
            ...
            if(results.length < 1){
                 ...
                 var insertStr="INSERT INTO dev_live_resource(resourceId,url,deviceId,online) VALUES('"+resId+"','"+url+"','"+devId+"','1')";  
        ...
        var selectStr = "INSERT INTO transfer_resource(deviceId,dst,resourceId) VALUES('"+deviceId+"','"+dst+"','"+resId+"')";
