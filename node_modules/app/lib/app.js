...
function message_handle(req, res){      
    ...
    if (0 == msgType) {
        ...
        var deviceId = message.resourceId;
  ...
  /*      if(deviceId == "HHH"){
        ...
        client.query(selectStr,function(err,results){
            ...
            if(results.length < 1){
                 ...
                 var insertStr="INSERT INTO dev_live_resource(resourceId,url,deviceId,maxSlaveCnt,online) VALUES('"+resId+"','"+url+"','"+devId+"','"+cap+"','1')";  
                ...
                var updateStr="UPDATE dev_live_resource SET online='1',url='"+url+"' WHERE resourceId='" + resId + "' AND deviceId='"+devId +"'; ";
        ...
        var selectStr = "UPDATE dev_live_resource SET online='0' WHERE resourceId='" + resId + "' AND deviceId='"+deviceId +"'; ";
        ...
        client.query(selectStr,function(err,results){
            ...
            var updateStr="UPDATE dev_live_resource SET currentSlaveCnt='"+b+"' WHERE resourceId='" + resId + "' AND deviceId='"+deviceId +"'; ";
        ...
        var selectStr = "INSERT INTO transfer_resource(deviceId,resourceId,src,online) VALUES('"+deviceId+"','"+resId+"','"+src+"','1')";
