        ...
        client.query(selectStr, function(err, result) {
            ...
            if(result.length < 1) {
                ...
                var insertStr = "INSERT INTO dev_user_mapping(deviceId,userId) "
                                + "SELECT '" + result[0].deviceId +"','" + userId +"' "
                                + "WHERE NOT EXISTS("
                                + "SELECT deviceId,userId FROM dev_user_mapping "
                                + "WHERE deviceId= '" + result[0].deviceId 
                                + "' AND userId='" + userId + "');"
...
/*修改*/
        ...
        client.query(selectStr, function(err, result) {
            ...
            var musicList = {
                ret: 0,
                //deviceId: result[0].deviceId,
                //musicUrl: result[0].publishVersion,
				musicUrl: "http://7xisq1.com1.z0.glb.clouddn.com/apicloud/0d0b81b8bd5ab81bda9ca54267eb9b98.mp3"
            };
