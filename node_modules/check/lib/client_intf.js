...
var pgString = db.connectstr.consqlString;
...
function database_response_to_select_handler(select_result)
{
    ...
    if ( 0 == select_result.rowCount)
    {
        ...
        var insert_string = "INSERT INTO tblequipment VALUES ('"
    ...
    else
    {
        ...
        /*    UPDATE tblequipment SET online = 0 WHERE sn = 'CZWB816MAH00019'; */
        var update_string = "UPDATE tblequipment SET onlinestatus = '1' WHERE sn = '" 
                          + this.register_obj.http_req.body.sn + "'";
        var update_query = client.query( update_string);
