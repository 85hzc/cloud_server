...
{ 
    ...
    else if ("device_online" == req.body.type)
    {
        ...
        query.setObj.skId = req.socket.id;
    ...
    else if ( "rsp_set" == req.body.type)
    {
    ...
    else if ("rsp_plugin_action" == req.body.type) {
        ...
        if (0 == req.body.ret) {
            ...
            else if ("update" == req.body.action) {
                var version = req.body.version; 
            ...
            else if ("delete" == req.body.action) {
