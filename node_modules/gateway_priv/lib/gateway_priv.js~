...
*/
  ...
  //          var socket = socket_arr.socket_arr_get(weixin_priv.weixin_socket.arr);
            var update_string = "UPDATE device_table SET run_status = '" + content[0].power_switch + "' WHERE device_id = '" 
                              + req.body.device_id + "';";
...
{          
    ...
    var update_string = "UPDATE device_table SET online = 'false' WHERE gateway_id = '" + this.id + "';";
