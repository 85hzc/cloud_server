...
{ 
    ...
    else if ("device_offline" == msg.type)
    {
        ...
        client.query(select_str, function(err, result) {
            ...
            var updateStr = "UPDATE iot_device set online='false' , \"devData\"='"
            ...
            client.query(updateStr, function(err, result1) {
                ...
                var endResult = {
                    ...
                    deviceId: result.rows[0].deviceId.toString()
                };
    ...
    else if ( "rsp_set" == msg.type)
    {
        ...
        var selectStr = "SELECT max(id) FROM lirc_code;";
        client.query(selectStr, function(err, result) {
            if (err) {
                console.error(err.stack);
                return;
            ...
            client.query(queryStr, function(err, result1) {
                ...
                var retStr = {
                    ...
                    commandId: commandId,
                    deviceId: deviceId,
                    version: result1.rows[0].version,
                    url: result1.rows[0].downloadUrl
                };
