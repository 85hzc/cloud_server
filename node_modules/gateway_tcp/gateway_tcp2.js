...
function insert_device_handler(row)
{
    if (row.length == 0) {
        ...
        var selectStr='SELECT @@IDENTITY AS deviceId';
...
{ 
    ...
    else if ("device_online" == msg.type)
    {
        ...
        client.query(select_str,function(err,result){
            if(result.length==0){
                ...
                var query_str = "SELECT * FROM iot_dev_datamodel" 
                       + " WHERE manufacture = '" + manufacture + "' AND "
                       + " manufactureDataModelId = '" + manufactureDataModelId + "';";
        ...
        query.on('result', insert_device_handler);
             ...
             query.on('result', device_online_handler);
