 ...
 /*   if ("login" == msgType) {
         ...
         if(err){
           ...
           result.forEach(function(row){   
             ...
             var value = {
                 ...
                 sharedLock:row.sharedLock,
                 sharedBW:row.sharedBW
    ...
    /*       result.forEach(function(row){   
           ...
           var value = {
                ret:0,
                msgType:"get_dev_one",
                sharedLock:result[0].sharedLock,
                sharedBW:result[0].sharedBW
    ...
    client.query(selectStr,function(err,result){
        ...
        if(result.length < 1){
            ...
            var insertStr="INSERT INTO shared_strategy(deviceId,sharedLock) VALUES('"+deviceId+"','"+sharedLock+"')";
            ...
            var updateStr="UPDATE  shared_strategy SET sharedLock='"+sharedLock+"' WHERE deviceId='"+deviceId+"' ";
    ...
    client.query(selectStr,function(err,result){
        ...
        if(result.length < 1){
            ...
            var insertStr="INSERT INTO shared_strategy(deviceId,sharedBW) VALUES('"+deviceId+"','"+sharedBW+"')";
            console.log(insertStr);
            ...
            var updateStr="UPDATE  shared_strategy SET sharedBW='"+sharedBW+"' WHERE deviceId='"+deviceId+"' ";
